...
public class Tube_Volant {
    ...
    public Tube_Volant(long mReference, float mPrix, String mSaison, String mClassement, long mCategorieID) {
    ...
    public long getmReference() {
        return mReference;
    }

    public void setmReference(long mReference) {
        this.mReference = mReference;
    }
